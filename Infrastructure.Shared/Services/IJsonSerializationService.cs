...
/// </summary>
public interface IJsonSerializationService<TOptions>
{
    #region Методы
    ...
    Task<string> SerializeAsync<TValue>(TValue value, IJsonSerializationOptions<TOptions>? options = null,
    ...
    Task<TValue> DeserializeAsync<TValue>(string json, IJsonSerializationOptions<TOptions>? options = null,
        CancellationToken cancellationToken = default);
